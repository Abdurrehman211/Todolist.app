    ...
    <>
      <nav className="navbar" ref={navref}>
        <div className="navbar-container">
          <a href="#" className="navbar-logo">Todo-list</a>
          <ul className={`navbar-menu ${isNavVisible ? 'responsive_nav' : ''}`}>
            <li className="navbar-item"><a href="#Home" className="navbar-link">Home</a></li>
            <li className="navbar-item"><a href="#App" className="navbar-link">Todo-app</a></li>
            <li className="navbar-item"><a href="#About" className="navbar-link">About</a></li>
            <li className="navbar-item">
              <button className="cta" onClick={toggleContactForm}>
            ...
            <button className="nav-btn nav-close-btn" id="nav-close-btn" onClick={showNavbar}>
              <FaTimes />
            </button>
          </ul>
      ...
      {isContactFormVisible && (
        ...
        <div class="card">
            ...
            <div class="glass"></div>
            <div class="content">
                <span class="title">Abdur rehman Abid</span>
                <span class="text">Full Stack Web-Developer</span>
            </div>
            <div class="bottom"> 
                <div class="social-buttons-container">
                    <button class="social-button .social-button1">
                        <a href="https://www.instagram.com/abdurrehman._abid/" target="_blank">
                      ...
                      <button class="social-button .social-button2">
                        <a href="https://wa.me/+923143241469?text=Hello%0AI'm%20intresting%20about%20the%20app%20Todo-app%20below" target="_blank">
          ...
          <div className="main1-21">
  {/* <img src={Image} alt="Profile" id="Profile" className="Profile" /> */}
  <button class="button1" data-text="Awesome">
    <span class="actual-text">&nbsp;Abdur Rehman Abid&nbsp;</span>
    <span aria-hidden="true" class="hover-text">&nbsp;Abdur Rehman Abid&nbsp;</span>
</button>
  <h2>Software Developer</h2>
  <p>As a full stack web developer, I can provide end-to-end web development services, including UI/UX design, front-end and back-end development, database management, and API integration.</p>
  <a href="https://abdurrehman-portfolio-121.netlify.app/" id="link121" target="_blank"><button class="connectBtn">
